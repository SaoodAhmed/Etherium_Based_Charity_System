...
<h2 class="text-center shadow" style="border-radius:50px; padding:10px; background: #a7be7a;"> Profile Information</h2>	 <br>

<div class="row p-3" >

<?php 
$sql= mysqli_query($conn,"select * from users where username='$_SESSION[user]'") or die("fail to optain campaign");
