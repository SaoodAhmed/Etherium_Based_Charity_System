...
<div class="container ">
<center>
<div class="card p-2 shadow " style="height: 450px; width:500px; background: transparent;">
<div class="text-center text-white"> <h2 class="mt-2 p-0" > Signup Donator</h2></div>
